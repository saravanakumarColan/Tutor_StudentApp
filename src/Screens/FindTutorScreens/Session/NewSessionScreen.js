  ...
  return (
    <>
      <View style={{ flex: 0.1, padding: 10 }}>
        ...
        <View style={{ height: View_Spacing.VS_W5 }} />
        <View
        style={{ flex: 0.1, flexDirection: "row", height: View_Spacing.VS_W5 }}
      >
        <View
      ...
      <View style={{ height: View_Spacing.VS_W5 }} />
      <View style={{flex:1,height:View_Spacing.VS_W15,borderRadius:Basic_Viewdimension.VD_BorderRadius,borderWidth:1,borderColor:LG_BG_THEME.App_Text_Blue,padding:10}}>
<TextInput 
multiline={true}
placeholder="Description" />
      ...
      <LinearGradient
        ...
        >
          ...
          >
            <Text
              style={{fontSize:fontSize.Medium,fontWeight:'300',letterSpacing:2,color:'#fff'}} 
            >
            {"SUBMIT"}
            </Text>
          </TouchableOpacity>
